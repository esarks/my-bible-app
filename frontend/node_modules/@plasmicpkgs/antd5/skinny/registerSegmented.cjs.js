...
function AntdSegmented(props) {
  ...
  return /* @__PURE__ */ React__default.default.createElement(antd.Segmented, __spreadValues({ options }, rest));
}
...
function getValueOptions(props) {
  ...
  if (props.useSlotOptions) {
    ...
    utils.traverseReactEltTree(props.optionsSlot, (elt) => {
      var _a2, _b;
...
function registerSegmented(loader) {
  utils.registerComponentHelper(loader, AntdSegmentedOption, {
    name: segmentedOptionComponentName,
    ...
    actions: [
      {
        ...
        onClick: ({ componentProps, studioOps }) => {
          const generateNewKey = () => {
            ...
            utils.traverseReactEltTree(componentProps.optionsSlot, (elt) => {
              var _a;
...
exports.AntdSegmentedOption = AntdSegmentedOption;
exports.registerSegmented = registerSegmented;
exports.segmentedComponentName = segmentedComponentName;
exports.segmentedOptionComponentName = segmentedOptionComponentName;
