    ...
    const childrenNode = props.mode === "simplified" ? /* @__PURE__ */ React__default.default.createElement(React__default.default.Fragment, null, (actualFormItems != null ? actualFormItems : []).map((formItem) => {
      ...
      return /* @__PURE__ */ React__default.default.createElement(
        ...
        /* @__PURE__ */ React__default.default.createElement(
          ...
          formItem.inputType === InputType.Text ? /* @__PURE__ */ React__default.default.createElement(antd.Input, null) : formItem.inputType === InputType.Password ? /* @__PURE__ */ React__default.default.createElement(antd.Input.Password, null) : formItem.inputType === InputType.TextArea ? /* @__PURE__ */ React__default.default.createElement(antd.Input.TextArea, null) : formItem.inputType === InputType.Number ? /* @__PURE__ */ React__default.default.createElement(antd.InputNumber, null) : formItem.inputType === InputType.Checkbox ? /* @__PURE__ */ React__default.default.createElement(AntdCheckbox, null, formItem.label) : formItem.inputType === InputType.Select ? /* @__PURE__ */ React__default.default.createElement(AntdSelect, { options: formItem.options }) : formItem.inputType === InputType.DatePicker ? /* @__PURE__ */ React__default.default.createElement(AntdDatePicker, { showTime: formItem.showTime }) : formItem.inputType === InputType.RadioGroup ? /* @__PURE__ */ React__default.default.createElement(
            AntdRadioGroup,
            {
...
const mapAntdComponentToInputType = /* @__PURE__ */ new Map([
  [antd.Input, InputType.Text],
  [antd.Input.TextArea, InputType.TextArea],
  [antd.Input.Password, InputType.Password],
  [antd.InputNumber, InputType.Number],
  [AntdSelect, InputType.Select],
  [AntdRadioGroup, InputType.RadioGroup],
  [antd.Radio, InputType.Radio],
...
function AntdBreadcrumb(props) {
  ...
  return /* @__PURE__ */ React__default.default.createElement(antd.Breadcrumb, __spreadProps$f(__spreadValues$n({}, rest), { items }));
}
  ...
  return /* @__PURE__ */ React__default.default.createElement(
    ...
    __spreadValues$c({
      ...
      itemRender: paginatedUrl ? (pageNo, _, originalElement) => {
        ...
        return React__default.default.cloneElement(originalElement, __spreadProps$4(__spreadValues$c({}, originalElement.props), {
          rel,
          href,
  ...
  const options = React.useMemo(() => {
    ...
    if (useSlotOptions) {
      ...
      return optionElts == null ? void 0 : optionElts.filter(
        (el) => {
          var _a3;
          return React__default.default.isValidElement(el) && ((_a3 = el.type) == null ? void 0 : _a3.name) === AntdSegmentedOption.name;
        }
      ).map((el) => ({
        value: el.props.value,
        label: /* @__PURE__ */ React__default.default.createElement(React__default.default.Fragment, null, el.props.children)
      }));
    }
    return (optionLabelObjs == null ? void 0 : optionLabelObjs.filter((l) => l.label && l.value)) || [];
  }, [optionsSlot, useSlotOptions, optionLabelObjs]);
  return /* @__PURE__ */ React__default.default.createElement(antd.Segmented, __spreadValues$8({ options }, rest));
}
...
function OutlineMessage$1() {
  return /* @__PURE__ */ React__default.default.createElement("div", null, "* To re-arrange options, use the Outline panel");
}
...
const AntdTable = React__default.default.forwardRef(function AntdTable2(props, ref) {
  ...
  const [uncontrolledSelectedRowKeys, setUncontrolledSelectedRowKeys] = React__default.default.useState(defaultSelectedRowKeys != null ? defaultSelectedRowKeys : []);
...
const AntdColumnGroup = antd.Table.ColumnGroup;
const AntdColumn = antd.Table.Column;
...
function AntdTooltip(props) {
  return /* @__PURE__ */ React__default.default.createElement(antd.Tooltip, __spreadProps$2(__spreadValues$2({}, props), { title: props.title || props.titleText }));
}
