...
function BaseDialogTrigger(props) {
  ...
  const canvasAwareIsOpen = utils.useIsOpen({
...
function registerDialogTrigger(loader, overrides) {
  utils.registerComponentHelper(
    ...
    BaseDialogTrigger,
    {
      name: utils.makeComponentName("dialogTrigger"),
      ...
      props: {
        ...
        dialog: {
          ...
          defaultValue: [
            {
              type: "component",
              name: registerModal.MODAL_COMPONENT_NAME,
              props: {
                children: {
                  type: "component",
                  name: registerDialog.DIALOG_COMPONENT_NAME,
                  props: {
                    children: registerModal.MODAL_DEFAULT_SLOT_CONTENT
                  }
                }
              }
            }
