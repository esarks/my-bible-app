...
const { variants, withObservedValues } = pickAriaComponentVariants(SLIDER_VARIANTS);
function BaseSlider(props) {
  ...
  return (
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(Slider, __spreadProps(__spreadValues({}, rest), { style: COMMON_STYLES }), ({ isDisabled }) => withObservedValues(
        children,
        {
          disabled: isDisabled
        },
...
function registerSlider(loader, overrides) {
  ...
  registerComponentHelper(
    ...
    BaseSlider,
    {
      ...
      props: __spreadProps(__spreadValues(__spreadValues({}, getCommonProps("slider", [
        "isDisabled",
        "aria-label"
...
export { BaseSlider, registerSlider };
