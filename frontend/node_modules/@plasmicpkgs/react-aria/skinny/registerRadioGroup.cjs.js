...
const { variants, withObservedValues } = variantUtils.pickAriaComponentVariants(RADIO_GROUP_VARIANTS);
function BaseRadioGroup(props) {
  ...
  return (
    ...
    /* @__PURE__ */ React__default.default.createElement(contexts.PlasmicRadioGroupContext.Provider, { value: __spreadProps(__spreadValues({}, props), { idManager }) }, /* @__PURE__ */ React__default.default.createElement(reactAriaComponents.RadioGroup, __spreadProps(__spreadValues({}, rest), { style: common.COMMON_STYLES }), ({ isDisabled, isReadOnly }) => withObservedValues(
      children,
      {
        disabled: isDisabled,
        readonly: isReadOnly
...
//# sourceMappingURL=registerRadioGroup.cjs.js.map
