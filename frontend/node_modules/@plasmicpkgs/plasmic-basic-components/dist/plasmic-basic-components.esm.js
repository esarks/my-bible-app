...
import React, { createElement, useRef, useEffect, useContext, Suspense, useState, useMemo } from 'react';
...
function Iframe(_ref) {
  ...
  return React.createElement("iframe", Object.assign({}, srcProps, {
    className: className,
    onLoad: onLoad
  }));
}
...
function registerRepeater(loader, customRepeaterMeta) {
  if (loader) {
    ...
    registerComponent$1(Repeater, customRepeaterMeta != null ? customRepeaterMeta : repeaterMeta);
  }
}
...
function Timer(_ref) {
  ...
  var isEditMode = useMemo(function () {
