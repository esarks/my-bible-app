...
function Iframe(_ref) {
  ...
  return React__default.createElement("iframe", Object.assign({}, srcProps, {
    className: className,
    onLoad: onLoad
  }));
}
...
function LoadingBoundary(_ref) {
  ...
  if (!isClient && !(plasmicQuery.isPlasmicPrepass != null && plasmicQuery.isPlasmicPrepass()) || forceLoading) {
