      ...
      {verses.length > 0 && (
        <div className="bg-white p-4 border rounded shadow mt-4">
          ...
          <div className="overflow-x-auto">
            <table className="table-auto w-full border-t border-gray-300 text-left">
              <thead className="bg-gray-100">
                <tr>
                  <th className="p-2 font-semibold w-3/4">📖 Verse</th>
                  <th className="p-2 font-semibold w-1/4">📝 Note</th>
                </tr>
              </thead>
              <tbody>
                {verses.map((v, i) => (
