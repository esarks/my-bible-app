...
import "./PlasmicModal.css"; // plasmic-import: GifuOWTp-sEP/css
  ...
  return (
    <BaseDialogTrigger
      ...
      className={classNames(
        ...
        "plasmic_mixins",
        "plasmic_tokens",
        "Modal__ariaDialogTrigger__vkhT",
        {
          Modal__ariaDialogTriggernoTrigger__vkhTpBjUp: hasVariant(
            $state,
            "noTrigger",
            "noTrigger"
          )
      ...
      dialog={
        <BaseModal
          ...
          className={classNames("__wab_instance", "Modal__ariaModal__qo7Sw", {
            Modal__ariaModalnoTrigger__qo7SwpBjUp: hasVariant(
              $state,
              "noTrigger",
              "noTrigger"
            )
          ...
          modalOverlayClass={classNames({ pcls_f9PJCHS1b6Ly: true })}
        ...
        >
          <BaseDialog
            ...
            className={classNames(
              "__wab_instance",
              "Modal__ariaDialog__u25C0",
              {
                Modal__ariaDialognoTrigger__u25C0PBjUp: hasVariant(
                  $state,
                  "noTrigger",
                  "noTrigger"
                )
          ...
          >
            ...
            <div
              ...
              className={classNames(
                ...
                "Modal__scrollableContent__wsm2X"
              )}
            >
              {renderPlasmicSlot({
                defaultContents: (
