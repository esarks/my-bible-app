...
import Checkbox from "../../components/Checkbox"; // plasmic-import: WjS4M1j2gD0o/component
...
import "./PlasmicCheckboxGroup.css"; // plasmic-import: MHC-BuzwOAy4/css
  ...
  return (
    <BaseCheckboxGroup
      ...
      className={classNames(
        ...
        "plasmic_mixins",
        "plasmic_tokens",
        "CheckboxGroup__ariaCheckboxGroup___4MPdw"
      )}
    ...
    >
      {$props.showLabel ? (
        <Label
          ...
          className={classNames("__wab_instance", "CheckboxGroup__label__wdba")}
        >
          {renderPlasmicSlot({
        ...
        defaultContents: (
          <Stack__
            ...
            className={classNames(
              ...
              "CheckboxGroup__freeBox__zdd4E"
            )}
          >
            <Checkbox
              className={classNames(
                "__wab_instance",
                "CheckboxGroup__checkbox__jybyo"
              )}
              label={"Option 1"}
              value={"option1"}
            />
            ...
            <Checkbox
              className={classNames(
                "__wab_instance",
                "CheckboxGroup__checkbox__hyv7Q"
              )}
              label={"Option 3"}
              value={"option3"}
            />
      ...
      {$props.showDescription ? (
        <Description
          ...
          className={classNames(
            "__wab_instance",
            "CheckboxGroup__description___991R"
          )}
        >
          {renderPlasmicSlot({
