...
import "./PlasmicOverlayArrow.css"; // plasmic-import: 3mhUBS6y6TBh/css

import TriangleFilledIcon from "./icons/PlasmicIcon__TriangleFilled"; // plasmic-import: _8WWLuEGbrxf/icon
  ...
  return (
    <BaseOverlayArrow
      ...
      className={classNames(
        ...
        "plasmic_mixins",
        "plasmic_tokens",
        "OverlayArrow__root__b9HuX",
        {
          OverlayArrow__rootdark__b9HuXsKvyK: hasVariant($state, "dark", "dark")
        }
      )}
    ...
    >
      <TriangleFilledIcon
        ...
        className={classNames(
          ...
          "OverlayArrow__svg__wv8A7",
          {
            OverlayArrow__svgdark__wv8A7SKvyK: hasVariant(
              $state,
              "dark",
              "dark"
            )
