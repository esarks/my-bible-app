...
import Button from "../../components/Button"; // plasmic-import: _vmwDeegthF4/component
...
import "./PlasmicDrawer.css"; // plasmic-import: pzL4ia7G958M/css
  ...
  return (
    <BaseDialogTrigger
      ...
      className={classNames(
        ...
        "plasmic_mixins",
        "plasmic_tokens",
        "Drawer__ariaDialogTrigger__eQgtx",
        {
          Drawer__ariaDialogTriggernoTrigger__eQgtxliT1J: hasVariant(
            $state,
            "noTrigger",
            "noTrigger"
          )
      ...
      dialog={
        <BaseModal
          ...
          className={classNames("__wab_instance", "Drawer__ariaModal__tEeEm", {
            Drawer__ariaModalnoTrigger__tEeEmliT1J: hasVariant(
              $state,
              "noTrigger",
              "noTrigger"
            )
          ...
          modalOverlayClass={classNames({ pcls_2TnzGSixE4qR: true })}
        ...
        >
          <BaseDialog
            ...
            className={classNames(
              "__wab_instance",
              "Drawer__ariaDialog__eOd6",
              {
                Drawer__ariaDialognoTrigger__eOd6LiT1J: hasVariant(
                  $state,
                  "noTrigger",
                  "noTrigger"
                )
            ...
            >
              ...
              <div
                ...
                className={classNames(
                  "plasmic_default__all",
                  "plasmic_default__div",
                  "Drawer__scrollableContent__kUqcC"
                )}
              >
                {renderPlasmicSlot({
                  defaultContents: (
