...
import "./PlasmicTextAreaInput.css"; // plasmic-import: o2tMRK8No0Bd/css
  ...
  return (() => {
    const child$Props = {
      ...
      className: classNames(
        ...
        "plasmic_mixins",
        "plasmic_tokens",
        "TextAreaInput__ariaTextArea__lWtqE",
        {
          TextAreaInput__ariaTextAreaflat_bottom__lWtqErGqoH: hasVariant(
            $state,
            "flat",
            "bottom"
          ),
          TextAreaInput__ariaTextAreaflat_left__lWtqEisq11: hasVariant(
            $state,
            "flat",
            "left"
          ),
          TextAreaInput__ariaTextAreaflat_right__lWtqE14YM: hasVariant(
            $state,
            "flat",
            "right"
          ),
          TextAreaInput__ariaTextAreaflat_top__lWtqErfDmE: hasVariant(
            $state,
            "flat",
            "top"
          ),
          TextAreaInput__ariaTextAreapadded_left__lWtqEw7JQj: hasVariant(
            $state,
            "padded",
            "left"
          ),
          TextAreaInput__ariaTextAreapadded_right__lWtqEGom09: hasVariant(
            $state,
            "padded",
            "right"
          ),
          TextAreaInput__ariaTextAreatype_plain__lWtqEqbjz6: hasVariant(
            $state,
            "type",
            "plain"
          ),
          TextAreaInput__ariaTextAreatype_soft__lWtqEtSw9B: hasVariant(
            $state,
            "type",
            "soft"
          )
