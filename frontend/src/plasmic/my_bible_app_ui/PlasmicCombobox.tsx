...
import "./PlasmicCombobox.css"; // plasmic-import: YXNN0PakvhyE/css
  ...
  return (
    <BaseComboBox
      ...
      className={classNames(
        ...
        "plasmic_mixins",
        "plasmic_tokens",
        "Combobox__ariaComboBox__vuJn1",
        {
          Combobox__ariaComboBoxtype_plain__vuJn13W5Uq: hasVariant(
            $state,
            "type",
            "plain"
          ),
          Combobox__ariaComboBoxtype_soft__vuJn1Jdd9V: hasVariant(
            $state,
            "type",
            "soft"
          )
    ...
    >
      {$props.showLabel ? (
        <Label
          ...
          className={classNames("__wab_instance", "Combobox__label__oqDqy")}
        >
          {renderPlasmicSlot({
