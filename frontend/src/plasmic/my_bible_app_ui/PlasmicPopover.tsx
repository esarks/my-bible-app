...
import OverlayArrow from "../../components/OverlayArrow"; // plasmic-import: 3mhUBS6y6TBh/component
...
import "./PlasmicPopover.css"; // plasmic-import: A1-LD4mUWu2-/css
  ...
  return (
    <BaseDialogTrigger
      ...
      className={classNames(
        ...
        "plasmic_mixins",
        "plasmic_tokens",
        "Popover__ariaDialogTrigger__m1FTc"
      )}
      dialog={
        <BasePopover
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button
            className={classNames("__wab_instance", "Popover__button___9GaiN")}
            label={"Open Popover"}
          />
        ),
