...
import "./PlasmicMenuItem.css"; // plasmic-import: rntCestMIkTl/css
    ...
    >
      <Stack__
        ...
        className={classNames(
          ...
          "MenuItem__freeBox__f8Tsa"
        )}
      >
        <BaseText
          data-plasmic-name={"ariaText"}
          data-plasmic-override={overrides.ariaText}
          className={classNames("__wab_instance", "MenuItem__ariaText__uJAgM")}
          slot={"label"}
        >
          <div
            className={classNames(
        ...
        {(() => {
          ...
          <BaseText2
            ...
            className={classNames(
              "__wab_instance",
              "MenuItem__ariaDescription__wXjGj"
            )}
            slot={"description"}
          >
            <div
