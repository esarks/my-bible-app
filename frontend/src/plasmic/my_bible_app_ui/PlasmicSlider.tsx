...
import "./PlasmicSlider.css"; // plasmic-import: ifBYl2wZn4Go/css
    ...
    >
        ...
        >
          {$props.showLabel ? (
            <Label
              ...
              className={classNames("__wab_instance", "Slider__label___4RsyV")}
            >
              {renderPlasmicSlot({
                defaultContents: (
                  <div
          ...
          {(() => {
            ...
            <BaseSliderOutput
              ...
              className={classNames(
                "__wab_instance",
                "Slider__ariaSliderOutput__hxAwh"
              )}
            >
              <React.Fragment>
      ...
      >
        ...
        >
          <BaseSliderTrack
            ...
            className={classNames(
              "__wab_instance",
              "Slider__ariaSliderTrack__vpkMt"
            )}
            progressBar={
              $props.filled ? (
                <div
      ...
      {$props.showDescription ? (
        <Description
          ...
          className={classNames("__wab_instance", "Slider__description__g0Oxa")}
        />
      ) : null}
    </BaseSlider>
