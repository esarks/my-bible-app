...
import "./PlasmicTooltip.css"; // plasmic-import: G-ssmNpBQkZS/css
  ...
  return (
        ...
        <React.Fragment>
          ...
          >
            {renderPlasmicSlot({
              ...
              value: args.content,
              className: classNames("Tooltip__slotTargetContent__stxbn")
            })}
          </Stack__>
        </React.Fragment>
      }
    ...
    >
      {renderPlasmicSlot({
        ...
        value: args.trigger,
        className: classNames("Tooltip__slotTargetTrigger__mgylW")
      })}
    </BaseTooltip>
