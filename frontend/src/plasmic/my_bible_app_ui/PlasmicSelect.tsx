...
import MenuPopover from "../../components/MenuPopover"; // plasmic-import: ncCDfHV98Ms9/component
...
import "./PlasmicSelect.css"; // plasmic-import: 0-29rT-D3boX/css
  ...
  return (
    <BaseSelect
      ...
      className={classNames(
        ...
        "plasmic_mixins",
        "plasmic_tokens",
        "Select__ariaSelect___6HjBi",
        {
          Select__ariaSelecttype_soft___6HjBIbnBxv: hasVariant(
            $state,
            "type",
            "soft"
          )
    ...
    >
      {$props.showLabel ? (
        <Label
          ...
          className={classNames("__wab_instance", "Select__label__ycCon")}
        >
          {renderPlasmicSlot({
      ...
      <BaseButton
        ...
        className={classNames("__wab_instance", "Select__ariaButton___4T4GV", {
          Select__ariaButtontype_soft___4T4GVbnBxv: hasVariant(
            $state,
            "type",
            "soft"
          )
      ...
      >
        <BaseSelectValue
          ...
          className={classNames(
            "__wab_instance",
            "Select__ariaSelectedValue___3Edlv"
          )}
          customize={true}
        >
          <div
      ...
      {$props.showDescription ? (
        <Description
          ...
          className={classNames("__wab_instance", "Select__description__mIsu8")}
        >
          {renderPlasmicSlot({
      ...
      <MenuPopover
        ...
        className={classNames("__wab_instance", "Select__menuPopover__rEjnU")}
