...
import "./PlasmicLabel.css"; // plasmic-import: hDD5SRwVjaSW/css
  ...
  return (
    <BaseLabel
      ...
      className={classNames(
        ...
        "Label__root__eE3TB",
        {
          Label__rootrequirementIndicator_optional__eE3TBQs2TG: hasVariant(
            $state,
            "requirementIndicator",
            "optional"
          ),
          Label__rootrequirementIndicator_required__eE3TBXuivm: hasVariant(
            $state,
            "requirementIndicator",
            "required"
          ),
          Label__rootsize_lg__eE3TBz4MYj: hasVariant($state, "size", "lg"),
          Label__rootsize_sm__eE3TB1HwPd: hasVariant($state, "size", "sm")
        }
      )}
    >
      <Stack__
        ...
        className={classNames(
          ...
          "Label__freeBox__nearT",
          {
            Label__freeBoxrequirementIndicator_optional__nearTQs2TG: hasVariant(
              $state,
              "requirementIndicator",
              "optional"
            ),
            Label__freeBoxsize_lg__nearTz4MYj: hasVariant($state, "size", "lg"),
            Label__freeBoxsize_sm__nearT1HwPd: hasVariant($state, "size", "sm")
          }
        )}
      >
        {renderPlasmicSlot({
          defaultContents: "BibleViewerApp",
          value: args.children,
          className: classNames("Label__slotTargetChildren__zGjHf", {
            Label__slotTargetChildrenrequirementIndicator_optional__zGjHfQs2TG:
              hasVariant($state, "requirementIndicator", "optional"),
            Label__slotTargetChildrenrequirementIndicator_required__zGjHfXuivm:
              hasVariant($state, "requirementIndicator", "required"),
            Label__slotTargetChildrensize_lg__zGjHfz4MYj: hasVariant(
              $state,
              "size",
              "lg"
            ),
            Label__slotTargetChildrensize_sm__zGjHf1HwPd: hasVariant(
              $state,
              "size",
              "sm"
            )
        ...
        <div
          ...
          className={classNames(
            ...
            "Label__text__xhe1N",
            {
              Label__textrequirementIndicator_optional__xhe1NQs2TG: hasVariant(
                $state,
                "requirementIndicator",
                "optional"
              ),
              Label__textrequirementIndicator_required__xhe1NXuivm: hasVariant(
                $state,
                "requirementIndicator",
                "required"
              )
