...
import "./PlasmicMenuSection.css"; // plasmic-import: l4LtOocBaQDx/css
      ...
      header={
        <div
          ...
          className={classNames(
            ...
            "MenuSection__freeBox__woch"
          )}
        >
          {renderPlasmicSlot({
            defaultContents: "Section Header",
            value: args.header,
            className: classNames("MenuSection__slotTargetHeader__jTBzF")
          })}
        </div>
      }
