...
import "./PlasmicTextInput.css"; // plasmic-import: aitFMueJo9TT/css
  ...
  return (() => {
    const child$Props = {
      ...
      className: classNames(
        ...
        "plasmic_mixins",
        "plasmic_tokens",
        "TextInput__ariaInput___1XlGg",
        {
          TextInput__ariaInputflat_bottom___1XlGg1NNbg: hasVariant(
            $state,
            "flat",
            "bottom"
          ),
          TextInput__ariaInputflat_left___1XlGg4XxwI: hasVariant(
            $state,
            "flat",
            "left"
          ),
          TextInput__ariaInputflat_right___1XlGgZuPkh: hasVariant(
            $state,
            "flat",
            "right"
          ),
          TextInput__ariaInputflat_top___1XlGgwtoRf: hasVariant(
            $state,
            "flat",
            "top"
          ),
          TextInput__ariaInputpadded_left___1XlGgMdnff: hasVariant(
            $state,
            "padded",
            "left"
          ),
          TextInput__ariaInputpadded_right___1XlGgIczd3: hasVariant(
            $state,
            "padded",
            "right"
          ),
          TextInput__ariaInputtype_plain___1XlGgfk9Lz: hasVariant(
            $state,
            "type",
            "plain"
          ),
          TextInput__ariaInputtype_soft___1XlGg05K6E: hasVariant(
            $state,
            "type",
            "soft"
          )
